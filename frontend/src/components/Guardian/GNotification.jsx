...
import { FaUserGraduate, FaCalendarAlt, FaChartLine, FaBell, FaSignOutAlt, FaEnvelope, FaSearch, FaClock, FaIdCard, FaMoneyCheck, FaRegCheckCircle } from 'react-icons/fa';
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-start mb-8 gap-4">
              ...
              <div className="flex gap-4 w-full md:w-auto">
                <button
                  onClick={markAsRead}
                  className="flex items-center bg-orange-700 hover:bg-orange-800 text-white px-6 py-2.5 rounded-lg transition-colors"
                >
                ...
                <div className="relative w-full md:w-64">
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-700"
                  />
                  ...
                  <div
                    ...
                    className={`p-6 bg-white rounded-xl shadow-sm flex items-start justify-between transition-all ${
                      !notification.read_at
                        ? 'border-l-4 border-orange-600 hover:shadow-md'
