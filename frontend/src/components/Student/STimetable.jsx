...
function STimetable() {
  ...
  const parseTime = (timeRange) => {
    // Extract the start time from the time range (e.g., "13:45 AM - 15:00 AM" => "13:45 AM")
    const startTime = timeRange.split(" - ")[0];

    // Normalize the time string to a format that can be parsed by `new Date`
    // Example: "8:30:45 AM" => "08:30:45 AM"
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 p-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-8">Student Timetable</h1>
