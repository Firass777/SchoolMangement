...
import { FaRegCheckCircle, FaCalendarAlt, FaChartLine, FaBell, FaSignOutAlt, FaEnvelope, FaSearch, FaClock, FaIdCard, FaChalkboardTeacher, FaBook, FaClipboardList } from 'react-icons/fa';
                  ...
                  <div
                    ...
                    className={`p-6 bg-white rounded-xl shadow-sm flex items-start justify-between transition-all ${
                      !notification.read_at
                        ? 'border-l-4 border-green-600 hover:shadow-md'
