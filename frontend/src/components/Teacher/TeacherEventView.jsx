...
import { FaChalkboardTeacher, FaCalendarAlt, FaChartLine, FaBell, FaSignOutAlt, FaBook, FaClipboardList, FaSearch, FaUserGraduate, FaEnvelope, FaClock, FaIdCard, FaArrowLeft, FaArrowRight, FaUsers, FaInfoCircle, FaTimes } from 'react-icons/fa';
