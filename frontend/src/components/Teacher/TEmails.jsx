...
import { FaUserGraduate, FaChalkboardTeacher, FaCalendarAlt, FaChartLine, FaBook, FaUsers, FaSchool, FaSignOutAlt, FaClipboardList, FaBell, FaEnvelope, FaPaperPlane, FaSearch } from 'react-icons/fa';
          ...
          <div className="w-1/3 p-6 border-r border-gray-200">
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="flex items-center px-4 py-2 bg-green-800 text-white rounded hover:bg-green-700"
              >
            ...
            <div className="flex space-x-4 mb-6">
              <button
                ...
                className={`px-4 py-2 rounded ${view === 'inbox' ? 'bg-green-800 text-white' : 'bg-gray-200 text-gray-800'}`}
              >
                Inbox
              </button>
              <button
                onClick={() => toggleView('sent')}
                className={`px-4 py-2 rounded ${view === 'sent' ? 'bg-green-800 text-white' : 'bg-gray-200 text-gray-800'}`}
              >
                Sent
              </button>
            </div>
